...
### 14. Migración a `russh` ⏸ LARGO PLAZO

libssh2 envejece (sin KEX post-cuántico, mantenimiento lento). `russh` (Rust puro, async) eliminaría OpenSSL vendored y todo el modelo de hilos de golpe. Migración grande de `ssh.rs` completo: evaluar en una rama dedicada. No urgente.
